...
void
Info::show_info (WINDOW *win, unsigned int speed, unsigned int distance,
                 int direction, unsigned int turns)
{
  ...
  mvwprintw (win, 6, 1, "Use %lc, %lc, %lc", WCHAR_ARROW_LEFT, WCHAR_ARROW_UP,
             WCHAR_ARROW_RIGHT);
